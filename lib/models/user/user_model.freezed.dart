...
// URL to the user's profile picture
  ...
  @override
  String toString() {
    return 'UserModel(uid: $uid, email: $email, displayName: $displayName, phoneNumber: $phoneNumber, photoURL: $photoURL, token: $token)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, uid, email, displayName, phoneNumber, photoURL, token);
...
abstract class _UserModel implements UserModel {
  ...
  @override
  String get phoneNumber; // User's phone number
  @override
